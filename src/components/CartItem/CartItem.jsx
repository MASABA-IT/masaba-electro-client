...
export default function CartItem({
  ...
  return (
    <div className="flex justify-between items-start gap-6 p-4 border-b-2 m-4 pb-6 bg-gray-50">
      {/* Left */}
      <div className="flex gap-4">
        ...
        />
        <div>
          <h2 className="xl:text-2xl font-semibold text-gray-900">
            {item.title}
          </h2>
          <p className="text-2xl text-gray-400">
            Size: {item.size}, Color: {item.color}, Material: {item.material}
          </p>
          <p className="text-2xl text-gray-400">Seller: {item.seller}</p>

          <div className="mt-4 space-x-4 text-2xl flex">
            {/* Remove Item Button */}
            <button
              className="text-red-500 border rounded-lg px-4 py-2 hover:bg-red-100 duration-75"
            ...
            <button
              className="text-blue-500 border rounded-lg px-4 py-2 hover:bg-blue-100 duration-75"
      ...
      <div className="text-right">
        ...
        <div className="mt-4 flex items-center gap-2 text-2xl">
          <button
            ...
            className="w-10 h-10 text-4xl rounded-lg bg-gray-100 hover:bg-gray-200 flex items-center justify-center"
          >
            -
          </button>
